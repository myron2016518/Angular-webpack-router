...
if (!__DEV__) {
    ...
    publicPath = process.env.NODE_ENV == 'test' ? 'http://dev2-houtai.siruijk.com/swi-doctor-web/' : 'http://test-houtai.siruijk.com/swi-doctor-web/';
    devtool = 'source-map';
}
...
var config = {
    ...
    resolve: {
        root: [],
        alias: {
            'JSEncrypt': path.resolve(__dirname, './lib/jsencrypt.js')
        }
    },
    //模块配置
    module: {
