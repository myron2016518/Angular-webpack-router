module.exports = angular.module("app.prescriptionaudit")
	.controller("prescriptionauditCtrl", ['$scope', '$state','$http', 'httpService', '$stateParams', '$timeout', '$rootScope', 'apiUrl', '$interval', 'ngDialog', 'Md5', function($scope, $state, $http, httpService, $stateParams, $timeout, $rootScope, apiUrl, $interval, ngDialog, Md5) {
		...
		$scope.getPDetail = function() {
			...
			var _pwd = '123456'
			$timeout(function(){
				document.getElementById("pdf").src= './NIM_Web/im/index.html?account='+_account+'&pwd='+_pwd+'&doctorName='+_doctorName+'&huanzheID='+_huanzheID+'&orderNo='+$scope.orderNo+'&patientName='+$scope.form.username+'&opentype='+_openType;
			},100)*/
	        ...
	        var timePA = $interval(function() {
				if($state.current.url != '/prescriptionaudit/:orderNo'){
