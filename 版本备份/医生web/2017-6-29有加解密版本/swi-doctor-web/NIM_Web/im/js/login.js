var Login = {
	...
	*/
	...
	requestLogin: function(account, pwd) {
		...
		window.location.href = './main.html?account='+_getAccount+'&pwd='+_getpwd+'&doctorName='+_doctorName+'&huanzheID='+_huanzheID+'&orderNo='+_orderNo+'&patientName='+_patientName+'&opentype='+_opentype;
...
Login.init();
$('#j-account').val(_getAccount);
$('#j-secret').val(_getpwd);
