module.exports = angular.module("app.prescriptionauditrx")
	.controller("prescriptionauditrxCtrl", ['$scope', '$state', 'httpService', '$stateParams', '$timeout', '$rootScope', 'apiUrl', '$interval', 'ngDialog', 'Md5', function($scope, $state, httpService, $stateParams, $timeout, $rootScope, apiUrl, $interval, ngDialog, Md5) {
					...
					if(dataPA.errCode == "000000") {
						...
						$timeout(function(){
		                	...
		                	if($rootScope.isStopOrder){
		                		...
		                		$state.go('examinerx.triallohandlerx');
		                	}
