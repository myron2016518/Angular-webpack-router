...
//var baseUrl = 'https://admin1.siruijk.com:8083'
//var baseUrl = 'https://poc-admin.siruijk.com:8083'
//var baseUrl = 'https://st-admin.siruijk.com:8083'
var baseUrl = 'https://sit-admin.siruijk.com:8083'
//var baseUrl = 'https://uat-admin.siruijk.com:8083'
...
.config(['$httpProvider', '$urlRouterProvider', '$locationProvider', function($httpProvider, $urlRouterProvider, $locationProvider) {
	if(window.location.pathname == "/swiPharmacistWeb/" || window.location.pathname == "/swiPharmacistWeb"){
		$urlRouterProvider.otherwise("/login");
	}else{
		$urlRouterProvider.otherwise("/loginrx");
	}
