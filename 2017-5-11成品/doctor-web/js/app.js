...
.controller("mainCtrl", ['$scope', '$state', '$rootScope', '$timeout', '$location', 'Md5', 'apiUrl', 'ngDialog', 'httpService', function($scope, $state, $rootScope, $timeout, $location, Md5, apiUrl, ngDialog, httpService) {
    ...
    .constant("apiUrl", {
        ...
        'startInquiry': { //医生进入候诊室开始接诊
            'url': baseUrl + '/app/inner/v1/inqiry/startInquiry',
            'method': 'GET'
        },
        'queueList': { //排队列表
        ...
        'pauseInquiry': { //医生暂停接单
            'url': baseUrl + '/app/inner/v1/inqiry/pauseInquiry',
            'method': 'GET'
        },
        'quitInquiry': { //医生退出候诊室
            'url': baseUrl + '/app/inner/v1/inqiry/quitInquiry',
            'method': 'GET'
        },
        'sumRecord': { //问诊记录数
        ...
        'send': {
            'url': baseUrl + '/app/open/v1/sms/send',
            'method': 'POST'
        },
        'check': {
